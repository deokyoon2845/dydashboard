...
# 섹터명 → KODEX 섹터 ETF 종목코드(.KS) · 모두 KRX 산업별 지수 추종
# 추가/수정은 여기만 고치면 됨. 코드가 틀리거나 데이터가 없는 섹터는 자동으로 빠짐.
SECTOR_ETFS = {
    ...
    "보험": "140700.KS",         # KODEX 보험
    "운송": "140710.KS",         # KODEX 운송
    "로봇": "0148J0.KS",         # TIGER 코리아휴머노이드로봇산업
    "기계장비": "102960.KS",     # KODEX 기계장비
    "건설": "117700.KS",         # KODEX 건설
    "철강": "117680.KS",         # KODEX 철강
    "에너지화학": "117460.KS",   # KODEX 에너지화학
    "바이오": "244580.KS",       # KODEX 바이오
    "필수소비재": "266410.KS",   # KODEX 필수소비재
    "미디어·엔터": "266360.KS",  # KODEX 미디어&엔터테인먼트
    # ── 테마형(소수 종목 집중) — KRX 산업지수가 아니라 변동성이 큼 ──
    "조선": "466920.KS",         # SOL 조선TOP3플러스
    "방산": "449450.KS",         # PLUS K방산 (FnGuide K-방위산업)
    "우주항공": "421320.KS",     # PLUS 우주항공&UAM
}
